...
<header>
  ...
  <div class="header__wrapper">
    <div class="container">
      ...
      <div class="header__text">Вкладывайте незначительные <br> деньги каждый день в копилку <br> своих знаний.</div>
...
<footer>
  <div class="footer__form">
    ...
    <input class="footer__form-name" type="text" placeholder="Введите ваше имя"/>
    <input class="footer__form-phone" type="text" placeholder="Введите ваш телефон"/>
    <input class="footer__form-email" type="email" placeholder="Введите ваш email"/>
